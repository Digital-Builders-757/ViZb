...
- **June 10, 2026 — Launch visual polish pass:** Public homepage, about, events, advertise, auth, nav/footer copy and glass/glow consistency; branded flyer fallbacks; unified `EmptyStateCard` + `NeonLink` CTAs. Audit: **`docs/design/LAUNCH_VISUAL_POLISH_AUDIT.md`**. Branch: `polish/launch-visual-pass`. No schema or flow changes.
