        ...
        {moment.events.map((e) => {
          ...
          return (
            <Link
              ...
              href={`/events/${e.slug}`}
              className="events-neon-card-hover group snap-start flex w-[78vw] shrink-0 flex-col overflow-hidden rounded-xl border border-[color:var(--neon-hairline)]/80 bg-[color:var(--neon-surface)]/20 md:w-auto"
            >
