...
- **June 11, 2026 — For You recommendations (#155):** **`lib/events/member-recommendations.ts`** scores upcoming events by preferences, saves, RSVPs, and staff picks; dashboard **`ForYouRail`** + **`/events?discover=for-you`** for signed-in users. Verified: **`npm run ci`**.
