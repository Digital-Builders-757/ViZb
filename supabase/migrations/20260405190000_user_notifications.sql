-- Member notification inbox (durable, mark-read). Staff can insert platform rows; members read/update own.
...
-- Platform inserts (broadcasts, host decisions) are staff-only; application uses service role or this policy.
