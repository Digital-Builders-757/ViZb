...
- **June 11, 2026 — Timeline CTA loop fix (#182):** Removed duplicate **Full timeline →** jump links from **`/events`** discovery rails; homepage keeps single **View full timeline →** entry. Verified: **`npm run ci`**.
