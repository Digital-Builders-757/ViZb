...
const proofPoints = [
  { value: "127+", label: "early members" },
  { value: "757", label: "home signal" },
  { value: "DMV", label: "next wave" },
  { value: "VA", label: "culture map" },
]

const pathways = [
  {
    title: "Find the night",
    description: "Use the full timeline when you want every party, workshop, mixer, and cultural move in one place.",
    href: "/events",
    label: "Open events",
    icon: CalendarDays,
  },
  {
    title: "Save the plan",
    description: "Join to save events, keep your week together, and come back to the listings you care about.",
    href: "/signup",
    label: "Join VIZB",
    icon: TicketCheck,
  },
  {
    title: "Host the room",
    description: "Bring your event into the VIZB system with a flyer-first page, RSVPs, tickets, and organizer tools.",
    href: "/host/apply",
  ...
  },
  {
    ...
    description: "Partner with the platform for thoughtful placements, sponsorships, and regional campaigns.",
    href: "/advertise",
...
export function HomeExperienceFlow() {
  return (
    <section className="home-flow-section relative overflow-hidden px-6 py-16 sm:px-8 md:py-24">
      <div className="relative z-10 mx-auto max-w-[1200px]">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div>
            <SectionTitle kicker="Why it sticks" title="From first scroll to actual plans." gradient />
            <p className="mt-5 max-w-prose text-base leading-relaxed text-[color:var(--neon-text1)] sm:text-lg">
              VIZB should feel like the local signal is alive: discover what is worth pulling up to,
              save it, share it, and move without losing momentum.
            </p>
          </div>
            ...
            return (
              <Link key={path.href} href={path.href} className="group block h-full">
                <GlassCard className="home-path-card flex h-full flex-col p-5 sm:p-6">
                  ...
                  <p className="mt-5 font-mono text-[10px] uppercase tracking-widest text-[color:var(--neon-a)]">
                    {path.label}
                  </p>
                </GlassCard>
              </Link>
          ...
          <div className="grid gap-0 lg:grid-cols-[1fr_0.9fr]">
            <div className="p-6 sm:p-8 md:p-10">
              ...
              <h2 className="mt-4 max-w-2xl text-balance font-serif text-2xl font-bold leading-tight text-[color:var(--neon-text0)] sm:text-3xl md:text-4xl">
                The site should feel like city light moving through tidewater.
              </h2>
              <p className="mt-5 max-w-2xl text-sm leading-relaxed text-[color:var(--neon-text1)] sm:text-base">
                Events lead with real flyers and photography. Hosts get tools that feel premium. Members get a
                personal command center that keeps the next move close.
              </p>
            ...
            <div className="home-editorial-bridge__panel min-h-[260px] p-6 sm:p-8">
              <div className="grid h-full gap-3">
                {[
                  ...
                  ["Commit", "RSVP, buy, save, or share without breaking flow."],
                  ["Return", "Your dashboard keeps tickets, saves, and recommendations close."],
                ].map(([title, copy]) => (
                  <div
                    key={title}
