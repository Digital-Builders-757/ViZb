...
**CLI twins (examples):** `026_event_rsvp_capacity.sql` ↔ `20260410120000_event_rsvp_capacity.sql`; **`20260410120500_enable_pgcrypto.sql`** (CLI-only: enables `pgcrypto` for `extensions.gen_random_bytes` in ticket mint SQL — apply before **`20260410142142`**); `028_tickets_core_free_rsvp.sql` ↔ `20260410142142_tickets_core_free_rsvp.sql`; `029_ticket_types_org_crud_and_mint_tier.sql` ↔ `20260410144936_ticket_types_org_crud_and_mint_tier.sql`; `030_stripe_checkout_fulfillment.sql` ↔ `20260411120000_stripe_checkout_fulfillment.sql`.
