# Visual system — ViBE (quick reference)

**Last updated:** March 23, 2026

**Full specification:** **`docs/BRAND_SYSTEM.md`** — this file is a **stub index** only. Do not duplicate token tables here; update `BRAND_SYSTEM` instead.
...
1. Open **`docs/BRAND_CONSTITUTION.md`**.  
2. Apply tokens from **`docs/BRAND_SYSTEM.md`**.  
3. Run **`/brand-check`**.
