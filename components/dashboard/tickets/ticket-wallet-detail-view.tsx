...
export async function TicketWalletDetailView({
  ticketId,
  ticketsListHref,
}: {
  ticketId: string
  /** e.g. `/tickets` (canonical) or `/dashboard/tickets` (legacy path) */
  ...
  return (
    <div className="min-w-0 space-y-6 md:space-y-8">
      <div className="flex flex-wrap items-center gap-3">
        <NeonLink href={ticketsListHref} variant="secondary" size="sm" className="w-full sm:w-auto">
          ← My tickets
        </NeonLink>
        <Link
