...
const ORG_TYPE_COLORS: Record<string, string> = {
  "music-collective": "text-brand-cyan border-brand-cyan/30 bg-brand-cyan/5",
  "event-company": "text-brand-blue-mid border-brand-blue-mid/30 bg-brand-blue-mid/5",
  "nightclub-venue": "text-brand-cyan-bright border-brand-cyan-bright/30 bg-brand-cyan-bright/5",
  "festival-org": "text-brand-blue border-brand-blue/30 bg-brand-blue/5",
  "community-group": "text-brand-cyan border-brand-cyan/30 bg-brand-cyan/5",
}
  ...
  if (applications.length === 0) {
    return (
      <div className="border border-dashed p-12 flex flex-col items-center text-center gradient-border">
        ...
        <span className="text-xs uppercase tracking-widest text-brand-cyan font-mono">All Clear</span>
  ...
  return (
    <div className="flex flex-col gap-4">
      {applications.map((app, index) => {
        ...
        const accentColors = ["border-l-brand-cyan", "border-l-brand-blue-mid", "border-l-brand-blue", "border-l-brand-cyan-bright"]
          ...
          >
            ...
            <div className="p-5 pb-0">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 bg-gradient-to-br from-brand-blue/20 to-brand-cyan/20 flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex flex-wrap gap-4 mt-3">
                  {app.website && (
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-xs text-brand-cyan font-mono hover:underline transition-colors"
                    >
                  ...
                  {app.social_links && (
                    <span className="inline-flex items-center gap-1.5 text-xs text-brand-blue-mid font-mono">
            ...
            {isApproved && (
              <div className="mx-5 mb-5 border border-brand-cyan/30 bg-brand-cyan/5 p-3 flex items-start gap-2">
                ...
                <div>
                  <p className="text-xs font-mono uppercase tracking-widest text-brand-cyan">Approved -- Org Created</p>
                  {result.org && (
