...
| Attendee home page | `app/(dashboard)/dashboard/page.tsx` | DONE — command center: hero + next move + stats, planner, tickets, saved-not-decided, vibe profile, local pulse, recommendations (discovery at bottom); first-run prefs + host/admin CTAs |
