    ...
    <GlassCard className="min-w-0 overflow-hidden p-4 sm:p-5">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
        <div className="min-w-0 flex-1">
          ...
          <Link
            href={`/events/${e.slug}`}
            className="mt-2 block font-serif text-lg font-bold leading-snug text-[color:var(--neon-text0)] underline-offset-4 hover:underline sm:text-xl break-words"
          >
            {e.title}
          </Link>
          <p className="mt-2 text-sm leading-relaxed text-[color:var(--neon-text1)] break-words">
